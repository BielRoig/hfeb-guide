...
description: "hFEB matchup guide against Enchantress."
layout: "matchup"
...
If your plan goes through **Survival**, you have to worry about **Seal of Cleansing**. If it goes through **Hermit Druid**, you have to respect **Swords to Plowshares**. If the game risks going longer, you have to consider **Argothian Enchantress**, **Solitary Confinement**, and especially **Abeyance**.
...
- **Argothian Enchantress**, if the opponent's hand looks slow but can develop an engine;
...
This means that even a **Triskelion** can't solve the problem. An Argothian left on the board for several turns can draw enough cards to let the opponent find Seal, Swords, Confinement, or Abeyance.
...
> You activate Hermit Druid.
> You put your entire library into the graveyard.
> In upkeep, you want to cast Krosan Reclamation to put cards back into the library.
> The opponent casts Abeyance.
> You can no longer cast Krosan Reclamation.
> On your draw step you lose because you can't draw a card.
...
- sometimes additional ways to protect the lock.

You don't normally expect cards like **Meddling Mage** or specific creatures. Their interaction stays mostly on enchantments, white removal, Crypt, and Abeyance.
...
> Swords can stop a Hermit Druid.
> Crypt can make an entire line difficult or impossible.
...
Post-board, instead, this approach becomes riskier.

If the opponent has more answers, more Abeyance, and Tormod's Crypt, using Spirit Guide to accelerate can expose you to a 2-for-1 or a line that's too fragile. It doesn't mean you should never do it, but it isn't automatically correct anymore.
...
- use Cabal Therapy based on your plan: Seal against Survival, Swords against Hermit, Argothian if the game goes long;
...
- give a lot of value to discard;
- don't be too optimistic with Elvish Spirit Guide post-board;
- carefully count the mana generated by Serra's Sanctum and Exploration.

In short: against Enchantress you're favored because you're faster, but you lose if you treat the matchup like a goldfish.

You have to be fast, but not blind. If you correctly identify the card that beats your plan — Seal, Swords, Crypt, Confinement, or Abeyance — you can use discard and removal to open a window and close before Enchantress really stabilizes.
