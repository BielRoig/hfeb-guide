...
description: "hFEB matchup guide against Goblins."
layout: "matchup"
...
There are Goblins hands you can beat fairly well: hands with slow development, too many utility lands, Matron/Ringleader without immediate pressure, or hands that can't remove your key creatures right away.

In these scenarios, your mana creatures and walls are very important. Even a seemingly simple card like a Wall can buy enough time to let you reach the kill. If the opponent doesn't have direct burn and can't remove the wall with **Gempalm Incinerator**, the Wall often stays on the board and blocks the 2/2s very well.
...
If it stays on the board, it lets you quickly build a kill line or find useful creatures to slow the board down. The main problem is that post-board the opponent can have **Naturalize** or similar effects, so you shouldn't always set up the game assuming Survival will stay active for many turns.
...
Personally, the plan is to cut a number of **Cabal Therapy**, but not all of them. Therapy is stronger against Goblins than it is against Sligh, because it can hit revealed or tutored cards. For example:
...
- **Uktabi Orangutan**, if you expect hate artifacts.
...
- a combination of acceleration and fast kill.
...
Walls are very important in the matchup.

Against Goblins, a 0/5 body blocks most of the opponent's basic creatures very well. Unlike Sligh, Goblins doesn't always have direct burn to remove a wall. If the opponent doesn't have **Gempalm Incinerator** or a way to push through combat, the wall can stay in play and buy several turns.
...
On top of that, if the wall produces mana, it serves a perfect dual role: it slows the clock and accelerates your plan.
...
- possibly other anti-enchantment or anti-graveyard effects depending on the list.
...
For example: before resolving Survival, it can be correct to use Therapy naming Naturalize. Before resolving Shapeshifter, it can be correct to name Pyroblast or Red Elemental Blast. After a Matron or a Ringleader, Therapy can become almost a "targeted" card, because you already know part of the opponent's hand.

This ability to turn the opponent's information into precise discard is one of the reasons Therapy is stronger here than against Sligh.
...
The important thing is not to use Pyroclasm too early if you aren't under immediate pressure. A Pyroclasm that kills only a Lackey can be correct in certain spots, but if you can afford to wait and turn it into a 3-for-1 or 4-for-1, the game often changes completely.
...
- respect **Goblin Lackey**;
- evaluate hands based on removal or a kill by turn 4;
- use Hermit Druid when the opponent has no pressure or immediate removal;
...
- don't underestimate the role of walls as cards that buy time and produce mana.

In short: Goblins can have very strong burst openings, but it's not a matchup where you start at a disadvantage. If you survive the early turns and convert Survival, removal, or Pyroclasm into a combo window well, you're often in the best position to win.
