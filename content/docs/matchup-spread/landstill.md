...
> Turn 2: **Cabal Therapy** naming **Swords to Plowshares**, flashing back Therapy if necessary, then **Hermit Druid**.
> Turn 3: activate Hermit Druid and try to close with **Unearth**, **Animate Dead**, or an equivalent line.
...
> Duress or Cabal Therapy to clear the opponent's hand.
> Survival of the Fittest.
> Discard a piece, tutor Palinchron.
> Reanimate or cast Volrath's Shapeshifter.
> Untap the mana and close in the same turn.
