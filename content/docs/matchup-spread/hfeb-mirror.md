...
title: "hFEB Mirror"
favorability: "even"
description: "hFEB matchup guide for the mirror match."
layout: "matchup"
...
As hFEB becomes more played and better understood — thanks to guides, testing, and broader exposure — the **mirror** has to be taken seriously.
...
### Mulligans When Playing Blind

The hardest part of Game 1 is the mulligan.

Knowing you're in the mirror, you'd want to mulligan hands that don't have a concrete plan by turn three. The problem is that often you don't know. Playing blind, a hand with a turn-four combo, or a slower but solid Survival hand, can be perfectly keepable against many decks in the format.

Against hFEB, though, that same hand can be too slow.

This is an important thing to accept: not all Game 1 losses in the mirror are avoidable. Sometimes your decision is correct against the field, but the specific pairing punishes you.

The practical rule is:

> If you know you're in the mirror, prioritize speed and disruption.
> If you're playing blind, you can't always mulligan as if you were playing the mirror.
...
- **Survival of the Fittest**, if the opponent's hand looks more oriented toward an engine line;
- **Naturalize**, if you're trying to protect your Survival;
- **Volrath's Shapeshifter**, if you're in a position where the opponent can already assemble the line;
- any post-board removal, if your line goes through a specific creature.
...
- **Swords to Plowshares**, for Hermit Druid or Shapeshifter;
- **Ghitu Slinger**, as removal tutorable with Survival;
- **Ray of Revelation**, to answer Survival;
- **Naturalize**, if present;
- possibly **Pyroclasm**, if you want to slow down mana creatures, Hermit Druid, and small setup pieces.
...
You should be more cautious, instead, about cutting too many mana creatures. For example, if you bring in Pyroclasm, the idea of cutting some **Birds of Paradise** makes sense, but in the mirror speed remains fundamental. So you have to be careful not to slow down too much.
...
## Pyroclasm in the Mirror

**Pyroclasm** is a debatable but understandable card.

On one hand it can significantly slow the opponent down, killing:

- Hermit Druid;
- Birds of Paradise;
- mana elves;
- Xantid Swarm, if present;
- other setup creatures.

On the other hand, Pyroclasm can also hurt your own development, especially if your plan goes through mana creatures or Druid.

For this reason there isn't a single right answer. Sideboarding Pyroclasm can be correct if you want to slow the opponent and play a slightly more interactive game. Not sideboarding it can be equally correct if you want to keep maximum speed and reduce situational cards.
...
## Interacting Without Diluting the Deck

The most important principle of sideboarding in the mirror is this:

> You want to increase interaction without losing the combo nature of the deck.

You shouldn't turn yourself into a deck full of answers. If you do, you risk losing to an opponent's hand that simply assembles Survival or Hermit before you.

Bring in removal and flexible answers, but without breaking the structure of the main deck too much. In particular, keep high the density of creatures and cards that let you assemble the combo.

The mirror punishes slow hands a lot, but it also punishes hands that are too reactive. A hand with two removal spells but no plan can still lose to a resolved Survival or to a more resilient sequence.
...
In Game 1, often whoever can present a realistic kill first wins. Interaction is minimal, and if you know you're in the mirror you have to look for hands with a very fast plan, ideally by turn three. The problem is that playing blind you can't always mulligan that way, because against the rest of the field slower hands can be correct.

Post-board, the matchup becomes slightly more interactive, but its nature doesn't change. Bring in spot removal and answers to Survival, but without diluting your combo plan too much.

The keys to the matchup are:

- winning the die roll helps a lot;
- look for hands with speed and at least minimal disruption;
- use Cabal Therapy to slow down the opponent's most likely plan;
- don't sideboard too heavily;
- don't turn into a mediocre control deck;
- bring in flexible removal and answers;
- remember that both the "close as fast as possible" plan and the "slow the opponent down with removal/Pyroclasm" plan can be correct.

In short: in the mirror there isn't always an elegant line. Often you have to be faster, disrupt just enough, and not lose sight of the fact that your deck still has to do what it's built for — winning quickly.

It's a matchup that can feel brutal, and in part it is. But post-board, with well-evaluated hands and light sideboarding, you can at least shift it from a pure race to a game where your small interactions actually make a difference.
