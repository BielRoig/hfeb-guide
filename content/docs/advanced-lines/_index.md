...
1. <i class="ms ms-g ms-cost"></i><i class="ms ms-tap ms-cost"></i> Activate Hermit on upkeep, order graveyard: Guide, Tog, Scrounger, WoR, Devourer, Trike<br>
   *(if under 6 mana available, activate on opponent's EOT instead)*
2. Cast Krosan Reclamation to put two Shifters back in the library<br>
