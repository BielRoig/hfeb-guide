...
A usual solution is to **stack activations**. This means holding priority and putting Devourer activations on the stack — as many as needed — without resolving them.
...
> Just remember to produce a Triskelion on top of the graveyard before the sacrifice trigger resolves!
